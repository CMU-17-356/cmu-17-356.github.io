...
How did it go? Did every test pass? If not, use your LLM to give you a plan on how it wants to fix the bugs (ask it for three alternative fixes). Choose the bug fix you like and have the LLM make the change. Did your test case pass? Congratulations! If not, try again.
   ...
   1. For each class you test
       1. Create a unit test feature in your GitHub Issues database. Make sure to keep the status of this Issue up to date on your Kanban board.
       1. Once you are done generating and testing your test code, commit it to the repository.
       1. Wrap up the commits into a pull request (PR) on GitHub and submit it. 
       1. Have a teammate or LLM do a code review on your PR and iterate until they are satisfied with the quality of the test code. Turn in the raw notes (or recording) from your human code review or the checklist you used and the LLM output if you asked an LLM to review your code.
       1. Approve the PR and merge it into main. Remember to keep the status of the user story up to date on your Kanban board.
   1. Turn in a URL to each class's unit test PR, identifying which class the PR was testing.
   1. If you used an LLM for any part of this section, please turn in a copy of the chat log or a URL to the chatlog that is accessible to all of the 17-356 instructors.
...
1. For each user story, 
    ...
    1. Once you are done generating and testing your acceptance test procedures and surveys, commit them to the repository.
    1. Wrap up the commits into a pull request (PR) on GitHub and submit it. 
    1. Have a teammate review your PR and iterate until they are satisfied with the quality of the acceptance test procedures and survey.
    1. Approve the PR and merge it into main. Remmeber to keep the status of the user story up to date on your Kanban board.
1. Turn in a URL to each user story's acceptance test PR, identifying which user story the PR was testing.
1. If you used an LLM for any part of this section, please turn in a copy of the chat log or a URL to the chatlog that is accessible to all of the 17-356 instructors.

### 5. Continue Implementing User Stories (Optional)

While this sprint is focused on documentation on testing, we would like you to continue 
creating and developing user stories to create your startup's application. There is no 
required number of user stories for P3. However, do continue to follow the software process
defined in [P2](p2) for implementing each user story's interface and implementation. 

Please record yourself showing off all of the new user stories implemented in P3 to a customer in a web browser or mobile device (include appropriate voiceover narration so we can follow what you're trying to show). This demo video will be a perfect addition to your personal project portfolio that you can show off when interviewing for jobs. If you have no new user stories, you need not create a new video.

1. If you made a video, upload it to YouTube. Make sure the video is accessible by the course instructors and turn in the URL. 

There are no points given for this section of the assignment. 

---
title: FP1 Final Team Sprint
---


# Final Project 1: Final Team Sprint


<p style="text-align: center;">
400 points<br/>  

Group assignment is due on Gradescope Wednesday, May 3, 2023 11:59pm<br/>
Individual assignment is due on Gradescope Monday, May 8, 2023 11:59pm<br/>
...
After one month of work, your investors want to see the progress on the product they poured their money into. They have your initial proposed timeline and user stories that you promised to deliver. Now is the time that you show them how much progress you have made and how awesome you are!
...
If your team has pivoted your project idea, you must reflect this on your project home page (see [FP1](../FP1)) and your Kanban board. Mark all old user stories as IRRELEVANT or WONTDO (or some other adjective that implies that you're no longer working on them). Be sure to create user stories to completely describe the new MVP you plan to build.
...
In this presentation, you will show your investors a walkthrough of your MVP. You do not need to include details related to the backend. Your investors are mostly interested in seeing the progress and functionality of your product. Your presentation should be 10-15 minutes and include a demo. You may use slides but are not required to. All team members must participate with each speaking for at least 2 minutes of time. 
...
**Note: All presentations will occur during our final exam slot, Thursday, May 4, 8:30am-11:30am.**
...
- You will schedule a meeting for all of your team's members sometime between Thursday, May 4, 11:30am and Monday, May 8, 11:59am. It has be after your team is done with your project and presentation so you can reflect on everything you have been through together this semester. 
...
Any team which fully completes its user stories on time will receive a 10% bonus for the final project portion of this class. As voted on by the class on March 30, 2023, bonuses will be given to each team and distributed according to the following scheme:
...
To help with the computation, note that the final project is worth 500 points (FP1 was 100 points, this assignment is 400 points). The total 10% bonus is therefore worth 50 points. The team's most valuable person receives 10 points. The remaining 40 points will be distributed evenly among all team members (even the team's most valuable person). 
